"""JSON Schema fragment types for tool parameter definitions.

All subclass :class:`~miniclaw.agent.tools.base.Schema`.
"""
...
from miniclaw.agent.tools.base import Schema
...
def tool_parameters_schema(
    ...
    **properties: Any,
    ...
    """Build root tool parameters schema for :func:`tool_parameters` decorator."""
    return ObjectSchema(
        required=required,
