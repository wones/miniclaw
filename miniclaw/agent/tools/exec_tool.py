"""Shell execution tool — async subprocess with comprehensive safety guards.

Based on miniclaw's shell.py design with deny/allow patterns,
SSRF protection, workspace restriction, and minimal env isolation.
"""
...
class ExecTool(Tool):
    """Execute shell commands with comprehensive safety guards."""
    ...
    def description(self) -> str:
        return (
            ...
            "Prefer read_file/write_file over cat/echo/sed. "
    ...
    async def execute(
        ...
        # Prevent working_dir escape when restrict_to_workspace is enabled
    ...
    def _guard_command(self, command: str, cwd: str) -> str | None:
        ...
        # Check allow patterns (whitelist mode)
        ...
        # SSRF protection
        try:
            from miniclaw.security.network import contains_internal_url
            if contains_internal_url(cmd):
                return "Error: Command blocked by safety guard (internal/private URL detected)"
        except ImportError:
            pass

        # Path traversal and workspace escape checks
